...
// Re-export design configuration for easy access
export * from './designConfig';

// Logic
export const WAVEFORM_ASPECT_RATIO = 0.4;
...
export const WAVEFORM_SPEED_MULTIPLIER = 0.7; // Slow down waveform animation
